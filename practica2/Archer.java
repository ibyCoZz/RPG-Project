...
public class Archer extends Character implements Skill{

    private final int BASE_DAMAGE;
    private ArrayList<Equipment> equipment;

    public Archer(String name, int health, int level, int xCoordinate, int yCoordinate, int strength, int agility, int mana, int gold, int range, int maxMana, int ultManaCost) {
        super(name, health, level, xCoordinate, yCoordinate, strength, agility, mana, gold, range, maxMana, ultManaCost);
        this.BASE_DAMAGE = 11;
        this.equipment = new ArrayList<>();
        this.equipment.add(new Weapon("Basic bow", 1, 5, "Bow", 0));
    ...
    public void ultimate(Entity enemy) {
        System.out.println("Hunter's shot...");

        int HUNTERS_SHOT_ULTIMATE_DAMAGE = 35;
        int allyDamage = (((Weapon)equipment.getFirst()).getExtraDamage() + BASE_DAMAGE + (HUNTERS_SHOT_ULTIMATE_DAMAGE + getLevel()));
